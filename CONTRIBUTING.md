...
1. Make an [Issue](https://github.com/ligofff/lgf-physics-usings/issues/new)
...
```json
    {
        "dependencies": {
            "com.ligofff.lgf-physics-usings": "https://github.com/YOUR_USER/lgf-physics-usings.git"
        }
    }
```
